# Business Model: Installation of Industrial Machinery and Equipment
...
## Classification
- Repository: `cloud-itonami-isic-3320` ([github.com/cloud-itonami/cloud-itonami-isic-3320](https://github.com/cloud-itonami/cloud-itonami-isic-3320))
- ISIC Rev.5: `3320` — Installation of Industrial Machinery and Equipment
- Domain: `:manufacturing/industrial-machinery-installation`
- Social impact: :worker-safety :rigging-hazard-containment :commissioning-reliability
- Actor: `:installation-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :manufacturing/industrial-machinery-installation — who wants
...
One managed tenant (:manufacturing/industrial-machinery-installation):
...
- Do not bypass the `:installation-governor` for production decisions.
