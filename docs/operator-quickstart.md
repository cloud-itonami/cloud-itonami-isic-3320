# Operator Quickstart — Installation of Industrial Machinery and Equipment

Shortest path from clone to a verified local dry-run for **ISIC 3320** (`cloud-itonami-isic-3320`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3320.git
cd cloud-itonami-isic-3320
```
...
- Blueprint governor key: `installation-governor`
- Likely source path: `installation.governor.cljc`
